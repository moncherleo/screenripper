...
import com.screenripper.recorder.ffmpeg.MyFFMpegRecorder;
...
import static com.screenripper.recorder.MyVideoRecorder.conf;

/**
 * Created by cherleo on 12/31/17.
 */
public class MyFFmpegWrapper {

    private static final Logger log = org.apache.log4j.Logger.getLogger(MyFFMpegRecorder.class);
    ...
    public String startFFmpeg(String... args) {
        ...
        final String[] commandsSequence = new String[]{
                MyFFmpegWrapper.RECORDING_TOOL,
                "-y",
                "-video_size", getScreenSize(),
                "-f", "avfoundation",
                "-i", "\"1:0\"",
                "-an",
                "-preset", "ultrafast", // encoding level
